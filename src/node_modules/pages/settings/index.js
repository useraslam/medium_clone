...
const Settings = () => {
    ...
    const handleSubmit = (e) => {
        ...
        dispatch({
            ...
            data: {
                user: {
                    ...currentUserState.currentUser, image, bio, username: name, email, password
                }
            }
        })
                        ...
                        <form onSubmit={handleSubmit}>
                            <fieldset>
                                <fieldset className='form-group'>
                                    <input type='text' className='form-control form-control-lg' placeholder='URL of profile picture' 
                                ...
                                <fieldset className='form-group'>
                                    <textarea rows='8' className='form-control form-control-lg' placeholder='Short bio' 
